...
if(isset($_POST['valider'])){
    if(!empty($_POST['email'])){
        ...
        if($recupUser->rowCount() > 0){
            ...
            $btocInser = $bdd->prepare('INSERT INTO btoc( first_name, last_name, email, phone, zip_adress, city, identity_card, users_id )values(? , ? ,?, ? ,? ,? ,? ,? )'); 
        
            $btocInser ->execute(array($nom,$prenom,$email,$contact, NULL, NULL, NULL,$_SESSION['id']));
...
<body>
    ...
    <div class="page">
        ...
        <header class="section page-header" id="home">
            ...
            <div class="rd-navbar-wrap">
                <nav class="rd-navbar rd-navbar-classic" data-layout="rd-navbar-fixed" data-sm-layout="rd-navbar-fixed" data-md-layout="rd-navbar-fixed" data-md-device-layout="rd-navbar-fixed" data-lg-layout="rd-navbar-static" data-lg-device-layout="rd-navbar-fixed"
                    data-xl-layout="rd-navbar-static" data-xl-device-layout="rd-navbar-static" data-xxl-layout="rd-navbar-static" data-xxl-device-layout="rd-navbar-static" data-lg-stick-up-offset="40px" data-xl-stick-up-offset="40px" data-xxl-stick-up-offset="40px"
        ...
        <!--form-->
        <form class="form-simple" id="form" method="POST">
            <h2 class="form-title">
              Formulaire de pré-inscription Btoc
            </h2>
                <div class="name">

                    <label for="first-name" class="first-name" 
                        id="private-first-name"> Prénom:
                        <input type="text" class="first-name" name="prenom" placeholder=>
                    </label>
    
                    <label for="last-name" class="last-name"> Nom:
                        <input type="text"  name="nom" class="last-name">
                    </label>
                </div>
                            ...
                            <div class="unit unit-spacing-sm flex-column flex-sm-row align-items-sm-center">
                                <div class="unit-left">
                                    <a class="brand" href="index.html">
                                        <img class="brand-logo-light" src="images/logo-inverse-105x38.png" alt="" width="105" height="38" srcset="images/logopromarket-removedbg.png" /></a>
                                </div>
                                <div class="unit-body">
                            ...
                            <div class="group group-lg group-middle">
                                ...
                                <div class="group-item">
                                    <ul class="list-inline list-inline-sm">
                                        <li>
                                            <a class="icon icon-lg link-default mdi mdi-facebook" href="#"></a>
                                        </li>
                                        <li>
                                            <a class="icon icon-lg link-default mdi mdi-twitter" href="#"></a>
                                        </li>
                                        <li>
                                            <a class="icon icon-lg link-default mdi mdi-youtube-play" href="#"></a>
                                        </li>
                                        <li>
                                            <a class="icon icon-lg link-default mdi mdi-instagram" href="#"></a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
